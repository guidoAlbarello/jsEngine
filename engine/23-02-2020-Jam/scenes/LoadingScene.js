...
/*	testMaterial2.setAlbedo("metal_albedo");
	...
	return this.scene;	this.scene.addCamera(new FirstPersonCamera([0.0, 2.8,0.0], [1.0, 2.8, -1.0]), "person");
	this.scene.useCamera("person");

	this.scene.addChild(gSurfaceCreator.makeSphere(1, 40));
