class Camera extends Object3d {
	...
	buildModelMatrix(fatherModelMatrix) {
		...
		vec3.scaleAndAdd(targetDir, this.object.target, this.object.position, -1);
		...
		this.object.modelMatrix = mat4.fromValues(
			this.object.UP[0], this.object.UP[1], this.object.UP[2], 0,
			this.object.binormal[0], this.object.binormal[1], this.object.binormal[2], 0,

			targetDir[0], targetDir[1], targetDir[2], 0,
			this.object.position[0], this.object.position[1], this.object.position[2], 1);

		let target = vec3.create();
		vec3.transformMat4(target, this.object.target, fatherModelMatrix);
		vec3.transformMat4(this.object.worldPosition, this.object.position, fatherModelMatrix);
		mat4.lookAt(this.object.viewMatrix, this.object.worldPosition, target, this.object.UP);
	}
}
