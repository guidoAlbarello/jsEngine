class BlinnPhongMaterial extends Material {
	...
	static setProjectionMatrix(projectionMatrix) {
		BlinnPhongMaterial.GLOBAL_UNIFORMS.push(
	...
	static setLight(light) {
		BlinnPhongMaterial.GLOBAL_UNIFORMS.push(
			Material.makeUniform("uAmbientLight", gRenderer.VEC3, light.ambient)
		);
		BlinnPhongMaterial.GLOBAL_UNIFORMS.push(
			Material.makeUniform("uDiffuseLight", gRenderer.VEC3, light.diffuse)
		);
		BlinnPhongMaterial.GLOBAL_UNIFORMS.push(
