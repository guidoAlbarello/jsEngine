class ExampleScene2dWithQuerySystem {
    ...
    build() {
        ...
        // Examples of query system.
        console.log(gQuerySystem.getPlayer());
        console.log(gQuerySystem.getAllObjectsWithTag("enemy"));
    ...
    setupEnemy() {
        let enemy = gEntityManager.instantiateObjectWithTag("enemy", Sprite, 1, 1, "entity", 64 / 256, 64 / 256);
